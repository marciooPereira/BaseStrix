...
AddEventHandler("vRP:Active", function(Passport, Name, Inventory)
	...
	TriggerEvent("Progress","Acordando",10000)
...
CreateThread(function()
	while true do
		...
		if GetPlayerMaxStamina(Pid) ~= 1000.0 then
			SetPlayerMaxStamina(Pid,1000.0)
			SetPlayerStamina(Pid,1000.0)
		end
...
function ReloadCharacter()
	...
	SetWeaponDamageModifier("WEAPON_UNARMED",0.05)
